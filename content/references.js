...
export const references = {
  ...
  'roam-apps': {
    ...
    use: 'The source of the DIFFICULTY PROGRESSIONS, not of the topic order. Read off the published item corpora rather than inferred: CALF\u2019s four named carry/borrow skills became the four stages of Composing and Decomposing Tens (the subscale names stay CALF\u2019s, because they are the instrument\u2019s and not ours); ARF\u2019s band walk set the order of the times tables; MagPI\u2019s own number line targets and comparison bins are used directly. Two structural facts mattered most \u2014 fraction placement on a number line is literally a MagPI construct, which is why it is the flagship; and ARF and CALF measure different things, which is why the recommender will not drill a procedure on top of missing facts. Izzi Math is practice, not assessment: it produces no score and predicts none.',
